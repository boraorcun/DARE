...
delete('Intake.mat', 'numerical_setup.mat', 'Performance_Results_for_Ramjet_Engine.txt', 'Ramjet_Combustor_Nozzle_Modules_Solution.txt');
...
flightComb(1) = 4; % Flight Mach number
