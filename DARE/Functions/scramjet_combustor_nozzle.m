function [dYdx, delete1, delete2] = scramjet_combustor_nozzle(x,Y)
    ...
    global module i reaction_key MW Mach_Mixture;
    global Comb_Length Comb_Area Comb_Cross_Section_Geometry area_gradient Cf;
    delete1=0;
    delete2=0;
